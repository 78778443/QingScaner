            ...
            <div class="tabbable" id="tabs-25550">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane" id="panel-910580">
                        ...
                        <form action="?m=info&c=new" method="POST" class="form-horizontal">

                            <div class="form-group">
                                <label class="col-sm-2 control-label">URL&nbsp;&nbsp;&nbsp;
                                    <font color="orange" size="2px">tag：添加多个URL时使用回车换行，每行一个URL地址</font></label>
                                <div class="col-sm-10">
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-2 col-sm-10">
                                    <div class="checkbox">
                                        <label>
                                            <input type="checkbox"  name="auth"/> 登录搜集
                                        </label>
                                    </div>
                                </div>
                            </div>
